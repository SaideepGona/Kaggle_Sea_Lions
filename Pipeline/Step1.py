...
SOURCEDIR = '/home/saideep/Github_Repos/Saideep/Kaggle_Sea_Lions/Sample_Data/'
...
first_no_dot = cv2.imread('../Sample_Data/Train/0.jpg')
diff1 = find_diff(first_dot, first_no_dot)
out = find_coords(diff1)
print(out)
'''
